...
import ClutchBitesCartItemComponent from '../components/ClutchBitesCartItemComponent';
import ClutchBitesComponent from '../components/ClutchBitesComponent';
...
export default function () {
  ...
  const handleOrder = () => {
    const destinationScreen = cart.length
      ? 'ClutchBitesCartSuccessScreen'
      : 'ClutchBitesHomeScreen';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <ClutchBitesCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
