...
import {kansasCityBBQ} from '../assets/products';

const ClutchBitesCartItemComponent = ({item}) => {
  ...
  const productImage = kansasCityBBQ.find(p => p.name === item.name)?.image;
...
export default ClutchBitesCartItemComponent;
